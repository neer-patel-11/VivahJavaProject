        ...
        <h2>Login</h2>
           ...
           <form action="login" method="POST">
            ...
            <a>
                ...
                <button id="submit" type="submit" name="button">LOGIN</button>
            </a>
        </form>
        <div style="text-align: center; color: white;">If haven't registered yet, <a href="./registerPage"
                style="color: white; padding:0.5rem;">Register Now</a></div>
